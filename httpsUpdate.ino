...
#ifndef APSSID
#define APSSID "202_NWK"
#define APPSK  "internet202"
#endif

const char* fingerprint = "CC AA 48 48 66 46 0E 91 53 2C 9C 7C 23 2A B1 74 4D 29 9D 33";
const char* host = "raw.githubusercontent.com";
const char* url = "/leoribg/ESP8266_OTA_HTTPS/master/images/Blink.ino.nodemcu.bin";
...
void loop() {
  ...
  if ((WiFiMulti.run() == WL_CONNECTED)) {
    ...
    t_httpUpdate_return ret = ESPhttpUpdate.update(String(host),httpsPort,String(url),String(""),String(fingerprint));
    // Or:
